        ...
        <div class="wrapper">
            ...
            <div class="login-form">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-box">
                        <i class='bx bxs-user-circle'></i><input type="text" name="title" class="space" placeholder="Research Title" required>
                    </div>
                    <!-- Research Author Input of the Form -->
                    <div class="input-box">
                        <i class='bx bxs-envelope'></i><input type="text" name="author" class="space" placeholder="Author" required>
                    </div>
                    <!-- Research File Input of the Form -->
                    <div class="file-box">
