...
if(isset($_POST['register-submit'])) {
    ...
    $select = "SELECT *FROM `admin_table` WHERE Email = '$email' AND Password = '$password'";
...
<head>
    ...
    <title>Admin Login | ISJAI Research Hub</title>
            ...
            <div class="login-form">
                ...
                <form action="#" method="post">
                    ...
                    <div class="login-register">
                        <p>Don't have an account? |<a href="./register.php"> Register</a> | <a href="./login-admin.php"> Student Login</a></p>
                    </div>
                </form>
            </div>
        </div>
