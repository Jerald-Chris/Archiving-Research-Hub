...
<body> 
    ...
    <section class="main">
        <div class="wrapper">
            <!-- ADD HUMSS DOCUMENTS of the Form -->
            <div class="login-form">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-box">
                        <i class='bx bxs-window-alt'></i><input type="url" name="link" class="space" placeholder="Add Link" required autocomplete="off">
                    </div>
                    <!-- Research Description Input of the Form -->
                    <div class="input-box-desc">
                        <i class='bx bxs-edit'></i><textarea id="description" name="description" class="space" maxlength="524288" placeholder="Research Description" required autocomplete="off"></textarea>
                    </div>
                    <!-- Research Strand Input of the Form -->
